...
If you manually copied a skill and accidentally placed it directly under `skills/`, run:
...
- Keep `catalog/skills.json` generated by the scripts; do not hand-edit it.
...
- Does `python3 scripts/validate_skills.py` pass after regenerating the catalog?
